# This script is to substract shared genetic component from Back pain in EA Replication study
...
fwrite(tr_sh_gwas[[2]], 
       row.names = F,
       file = '/mnt/polyomica/projects/bp-sh/data/04_bp-sh/bp-sh_replication/EA/BP-SH_ea_repl.txt',
       sep = '\t')
