# This script is to substract shared genetic component from Back pain in AA Replication study
...
gwas_files <- c('../../../data/00_upload_to_db/01_replication/AA/00_original_traits/unification_results/Hip/Hip_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/AA/00_original_traits/unification_results/Back/Back_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/AA/00_original_traits/unification_results/Neck/Neck_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/AA/00_original_traits/unification_results/Knee/Knee_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/AA/00_original_traits/unification_results/Head/Head_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/AA/00_original_traits/unification_results/Stom/Stom_output_done.csv')
...
fwrite(tr_sh_gwas[[2]], 
       row.names = F,
       file = '/mnt/polyomica/projects/bp-sh/data/04_bp-sh/bp-sh_replication/AA/BP-SH_aa_repl.txt',
       sep = '\t')
