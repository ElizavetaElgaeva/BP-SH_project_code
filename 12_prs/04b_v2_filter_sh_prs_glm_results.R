...
thr <- 0.05/(3*(length(sh_test_nonr_var1_cov) + length(opcs_sh_test_nonr_var1) + 6)) # p = 3.687316e-05 is a significance threshold for glm() analyses; 6 - is a number of pain traits, glm results for them were included later
...
# 0.8915  1.0815  1.1247  1.1284  1.1734  1.3426
...
sh_icd <- sh_test_nonr_var1_cov[pval_icd_i] # glm() results for ICD10 codes against SH PRS, significant; N = 135
or_sh_icd <- or_icd[pval_icd_i]

readme_sh_icd <- "glm() results for ICD10 codes level 2 against SH PRS, significant"
save(readme_sh_icd, or_sh_icd, sh_icd, file = "./glm_icd_level_2_sh_prs_filtered_test_nonrelatives.RData")
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
# 0.9111  1.0552  1.1097  1.1116  1.1545  1.3683
...
sh_opcs <- opcs_sh_test_nonr_var1[pval_opcs_i] # glm() results for ICD10 codes against SH PRS, significant; N = 87
or_sh_opcs <- or_opcs[pval_opcs_i]

readme_sh_opcs <- "glm() results for OPCS codes level 2 against SH PRS, significant"
save(readme_sh_opcs, or_sh_opcs, sh_opcs, file = "./glm_opcs_level_2_sh_prs_filtered_test_nonrelatives.RData")
