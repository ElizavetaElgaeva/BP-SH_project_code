...
#length(if_10_sh) == nrow(opcs_cases_f_l2_test_nonr_prev) # TRUE
...
#if_10_sh_vs_opcs <- lapply(opcs_cases_f_l2_test_nonr_prev[, c(23:154)], function(x)
...
#readme_if_10_sh_vs_opcs <- "glm(binomial) results for OPCS codes level 2, X, Y, Z codes excluded, from opcs_iid_cases_level_2_cbp_prev_filtered_test_nonrelatives.RData against binary coded PRS trait reflecting relatedness to 0.1 quantile for SH"
#save(if_10_sh_vs_opcs, readme_if_10_sh_vs_opcs, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/opcs_level_2_no_xyz_vs_bin_prs_10_sh.RData")


#if_10_bp_sh_vs_opcs <- lapply(opcs_cases_f_l2_test_nonr_prev[, c(23:154)], function(x)
...
#readme_if_10_bp_sh_vs_opcs <- "glm(binomial) results for OPCS codes level 2, X, Y, Z codes excluded, from opcs_iid_cases_level_2_cbp_prev_filtered_test_nonrelatives.RData against binary coded PRS trait reflecting relatedness to 0.1 quantile for BP-SH"
#save(if_10_bp_sh_vs_opcs, readme_if_10_bp_sh_vs_opcs, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/opcs_level_2_no_xyz_vs_bin_prs_10_bp_sh.RData")


#if_90_sh_vs_opcs <- lapply(opcs_cases_f_l2_test_nonr_prev[, c(23:154)], function(x)
...
#readme_if_90_sh_vs_opcs <- "glm(binomial) results for OPCS codes level 2, X, Y, Z codes excluded, from opcs_iid_cases_level_2_cbp_prev_filtered_test_nonrelatives.RData against binary coded PRS trait reflecting relatedness to 0.9 quantile for SH"
#save(if_90_sh_vs_opcs, readme_if_90_sh_vs_opcs, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/opcs_level_2_no_xyz_vs_bin_prs_90_sh.RData")


#if_90_bp_sh_vs_opcs <- lapply(opcs_cases_f_l2_test_nonr_prev[, c(23:154)], function(x)
...
#readme_if_90_bp_sh_vs_opcs <- "glm(binomial) results for OPCS codes level 2, X, Y, Z codes excluded, from opcs_iid_cases_level_2_cbp_prev_filtered_test_nonrelatives.RData against binary coded PRS trait reflecting relatedness to 0.9 quantile for BP-SH"
#save(if_90_bp_sh_vs_opcs, readme_if_90_bp_sh_vs_opcs, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/opcs_level_2_no_xyz_vs_bin_prs_90_bp_sh.RData")
