...
thr <- 0.05/(3*(length(bp_sh_test_nonr_var1_cov) + length(opcs_bp_sh_test_nonr_var1) + 6)) # p = 3.599712e-05 is a significance threshold for glm() analyses; 6 - is a number of pain traits, glm results for them were included later
