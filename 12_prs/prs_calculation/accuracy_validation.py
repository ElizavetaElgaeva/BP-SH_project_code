...
trait = sys.argv[3]
path_to_val_list = "/home/anostaeva/Back_Pain_project/Back_Pain_2022/phenotype/validation_list.txt"
...
if PHENOTYPE == "back":
    ...
    df_re_estimate.to_csv(f"./data/{trait}_val_results.csv", mode='a', index=False, header=False)
else:
