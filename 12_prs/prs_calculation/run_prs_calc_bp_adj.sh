...
path_to_out="/home/anostaeva/Back_Pain_project/Back_Pain_2022/UKB_all_PRS/bp_adj"
...
path_to_code="/home/anostaeva/Back_Pain_project/Back_Pain_2022/UKB_all_PRS/bp_adj"
...
plink2 --pfile ${path_to_ukb}/ukb_imp_chr${i}_v3_filtered \
       ...
       --score ${path_to_gwas}/BP_adj_model_${id}_genome.csv 1 3 6 header cols=scoresums \
       --out ${path_to_out}/ukb_imp_chr_${i}_v3_PRS
done

singularity exec /home/anostaeva/py.sif python3 ${path_to_code}/create_prs.py ${path_to_out} ukb_bp_adj_${id}
