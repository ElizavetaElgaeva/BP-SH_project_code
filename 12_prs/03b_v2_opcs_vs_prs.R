...
# Start with BP PRS
opcs_bp_test_nonr_var1 <- lapply(opcs_f_l2_test_nonr_prev[, -c(1:22)], function(x) 
...
readme_opcs_bp_test_nonr_var1 <- "glm(binomial) results for OPCS codes (level 2) from opcs_iid_level_2_cbp_prev_filtered_test_nonrelatives.RData against standardized BP PRS"
save(opcs_bp_test_nonr_var1, readme_opcs_bp_test_nonr_var1, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/opcs_level_2_vs_bp_prs_test_nonrelatives_var1.RData") 

# Start with SH PRS
opcs_sh_test_nonr_var1 <- lapply(opcs_f_l2_test_nonr_prev[, -c(1:22)], function(x)
...
readme_opcs_sh_test_nonr_var1 <- "glm(binomial) results for OPCS codes (level 2) from opcs_iid_level_2_cbp_prev_filtered_test_nonrelatives.RData against standardized SH PRS"
save(opcs_sh_test_nonr_var1, readme_opcs_sh_test_nonr_var1, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/opcs_level_2_vs_sh_prs_test_nonrelatives_var1.RData")

# Start with BP-SH PRS
opcs_bp_sh_test_nonr_var1 <- lapply(opcs_f_l2_test_nonr_prev[, -c(1:22)], function(x)
...
readme_opcs_bp_sh_test_nonr_var1 <- "glm(binomial) results for OPCS codes (level 2) from opcs_iid_level_2_cbp_prev_filtered_test_nonrelatives.RData against standardized BP-SH PRS"
save(opcs_bp_sh_test_nonr_var1, readme_opcs_bp_sh_test_nonr_var1, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/opcs_level_2_vs_bp_sh_prs_test_nonrelatives_var1.RData")
