...
# Start with BP PRS
bp_test_nonr_var1_cov <- lapply(icd_f_l2_test_nonr_prev[, -c(1:22)], function(x) 
...
readme_bp_test_nonr_var1_cov <- "glm(binomial) results for ICD10 codes level 2 from icd10_iid_level_2_cbp_prev_filtered_test_nonrelatives.RData against standardized BP PRS"
save(bp_test_nonr_var1_cov, readme_bp_test_nonr_var1_cov, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/icd10_level_2_vs_bp_prs_test_nonrelatives_var1.RData") 

#rm(bp_test_nonr_var1_cov, readme_bp_test_nonr_var1_cov)

# Start with SH PRS
sh_test_nonr_var1_cov <- lapply(icd_f_l2_test_nonr_prev[, -c(1:22)], function(x)
...
readme_sh_test_nonr_var1_cov <- "glm(binomial) results for ICD10 codes level 2 from icd10_iid_level_2_cbp_prev_filtered_test_nonrelatives.RData against standardized SH PRS"
save(sh_test_nonr_var1_cov, readme_sh_test_nonr_var1_cov, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/icd10_level_2_vs_sh_prs_test_nonrelatives_var1.RData")

# Start with BP-SH PRS
bp_sh_test_nonr_var1_cov <- lapply(icd_f_l2_test_nonr_prev[, -c(1:22)], function(x)
...
readme_bp_sh_test_nonr_var1_cov <- "glm(binomial) results for ICD10 codes level 2 from icd10_iid_level_2_cbp_prev_filtered_test_nonrelatives.RData against standardized BP-SH PRS"
save(bp_sh_test_nonr_var1_cov, readme_bp_sh_test_nonr_var1_cov, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/icd10_level_2_vs_bp_sh_prs_test_nonrelatives_var1.RData")
