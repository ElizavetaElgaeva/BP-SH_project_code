...
#load("binary_prs_test_nonrelatives_cases_nonoverlapping_quantiles.RData") # binary coded PRS data
...
#length(if_10_sh) == nrow(icd_cases_f_l2_test_nonr_prev) # TRUE
...
#if_10_sh_vs_icd <- lapply(icd_cases_f_l2_test_nonr_prev[, c(23:187)], function(x)
...
#readme_if_10_sh_vs_icd <- "glm(binomial) results for ICD10 codes level 2, chapter I - XVII, from icd10_iid_cases_level_2_cbp_prev_filtered_test_nonrelatives.RData against binary coded PRS trait reflecting relatedness to 0.1 quantile for SH"
#save(if_10_10_vs_icd, readme_if_10_sh_vs_icd, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/icd10_level_2_chapter_1-17_vs_bin_prs_10_sh.RData")
...
#if_10_bp_sh_vs_icd <- lapply(icd_cases_f_l2_test_nonr_prev[, c(23:187)], function(x)
...
#readme_if_10_bp_sh_vs_icd <- "glm(binomial) results for ICD10 codes level 2, chapter I - XVII, from icd10_iid_cases_level_2_cbp_prev_filtered_test_nonrelatives.RData against binary coded PRS trait reflecting relatedness to 0.1 quantile for BP-SH PRS"
#save(if_10_bp_sh_vs_icd, readme_if_10_bp_sh_vs_icd, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/icd10_level_2_chapter_1-17_vs_bin_prs_10_bp_sh.RData")
...
#if_90_sh_vs_icd <- lapply(icd_cases_f_l2_test_nonr_prev[, c(23:187)], function(x)
...
#readme_if_90_sh_vs_icd <- "glm(binomial) results for ICD10 codes level 2, chapter I - XVII, from icd10_iid_cases_level_2_cbp_prev_filtered_test_nonrelatives.RData against binary coded PRS trait reflecting relatedness to 0.9 quantile for SH PRS"
#save(if_90_sh_vs_icd, readme_if_90_sh_vs_icd, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/icd10_level_2_chapter_1-17_vs_bin_sh_prs_90_sh.RData")
...
#if_90_bp_sh_vs_icd <- lapply(icd_cases_f_l2_test_nonr_prev[, c(23:187)], function(x)
...
#readme_if_90_bp_sh_vs_icd <- "glm(binomial) results for ICD10 codes level 2, chapter I - XVII, from icd10_iid_cases_level_2_cbp_prev_filtered_test_nonrelatives.RData against binary coded PRS trait reflecting relatedness to 0.9 quantile for BP-SH"
#save(if_90_bp_sh_vs_icd, readme_if_90_bp_sh_vs_icd, file = "/mnt/polyomica/projects/bp-sh/data/12_prs/icd10_level_2_chapter_1-17_vs_bin_prs_90_bp_sh.RData")
