...
united_corr_table$cov <- united_corr_table$rg*sqrt(united_corr_table$h2_obs_1)*sqrt(united_corr_table$h2_obs_2) # calculate genetic covariance
united_corr_table$cov_se <- united_corr_table$cov/united_corr_table$z # calculate standard error of genetic covariance
...
# Create matrix of genetic covariance standard error
