...
# obtained for six pain traits and GIP1 obtained for four musculosceletal pain traits
...
gip1[5] <- 0.0000000
gip1 <- append(gip1, 0.0000000, 5) # add zeros to obtain the same length of the vector as the alphas vector

# Estimate the expected genetic correlation between Shared Heredity obtained for six pain traits and GIP1 of four pain traits
