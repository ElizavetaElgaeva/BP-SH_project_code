# This script is to adjust UGIT CBP for chronic headache and knee pain 
# in Replication cohort of South Asian ancestry
...
gwas_files <- c('../../../data/00_upload_to_db/01_replication/SA/02_bp-sh/unification_results/BP-SH_sa_repl_output_done.csv',
...
fwrite(tr_sh_adj_gwas[[2]], 
       row.names = F,
       file = '/mnt/polyomica/projects/bp-sh/data/13_bp-sh_adj/bp-sh_adj_replication/SA/BP-SH_adj_sa_repl.txt',
       sep = '\t')
