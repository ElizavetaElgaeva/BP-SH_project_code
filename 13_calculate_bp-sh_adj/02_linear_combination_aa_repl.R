...
# in Replication cohort of African ancestry
...
gwas_files <- c('../../../data/00_upload_to_db/01_replication/AA/02_bp-sh/unification_results/BP-SH_aa_repl_output_done.csv',
...
fwrite(tr_sh_adj_gwas[[2]], 
       row.names = F,
       file = '/mnt/polyomica/projects/bp-sh/data/13_bp-sh_adj/bp-sh_adj_replication/AA/BP-SH_adj_aa_repl.txt',
       sep = '\t')
