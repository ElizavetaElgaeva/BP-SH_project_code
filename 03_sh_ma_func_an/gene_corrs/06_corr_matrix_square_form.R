...
rownames(wide_p) <- wide_p$gwas_id_1
wide_rg<-wide_rg[,-1]
wide_se<-wide_se[,-1]
wide_p<-wide_p[,-1]
...
write.csv(wide_p,'../../../../data/03_sh_ma_func_an/gene_corrs/gene_corr_p_matrix.csv',row.names=T)
