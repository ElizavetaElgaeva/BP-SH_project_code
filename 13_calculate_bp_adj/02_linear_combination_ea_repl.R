# This script is to adjust CBP for all other original chronic pain traits 
# in Replication cohort of European ancestry
...
gwas_files <- c('../../../data/00_upload_to_db/01_replication/EA/00_original_traits/unification_results/Hip/Hip_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/EA/00_original_traits/unification_results/Back/Back_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/EA/00_original_traits/unification_results/Neck/Neck_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/EA/00_original_traits/unification_results/Knee/Knee_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/EA/00_original_traits/unification_results/Head/Head_output_done.csv',
		'../../../data/00_upload_to_db/01_replication/EA/00_original_traits/unification_results/Stom/Stom_output_done.csv')
...
fwrite(tr_sh_adj_gwas[[2]], 
       row.names = F,
       file = '/mnt/polyomica/projects/bp-sh/data/13_bp_adj/bp_adj_replication/EA/BP_adj_ea_repl.txt',
       sep = '\t')
