...
# BP adjusted for all other original pain traits 
...
# Estimate pairwise genetic correlations for adjusted BP and other traits
cor_gi_a1_a2(a1 = alphas, a2 = aa, covm = gcov[c(1:6), c(1:6)]) 
#[1] 0.151285 rg for adjusted bp and sh
cor_gi_a1_a2(a1 = position[2, ] - alphas*slope[2], a2 = aa, covm = gcov[c(1:6), c(1:6)])
#[1] 0.8021326 rg for adjusted bp and bp-sh
tmp <- lapply(n_traits, function(x) cor_gi_alfa(i = n_traits[x], a = aa, covm = gcov))
#[[1]]
#[1] 3.604807e-11 rg for adjusted bp and hip pain
#[[2]]
#[1] 0.4823323 rg for adjusted bp and back pain
#[[3]]
#[1] -2.194532e-10 rg for adjusted bp and neck pain
#[[4]]
#[1] 1.845365e-10 rg for adjusted bp and knee pain
#[[5]]
#[1] 2.357728e-10 rg for adjusted bp and head pain
#[[6]]
#[1] 7.117874e-11 rg for adjusted bp and stomach pain
